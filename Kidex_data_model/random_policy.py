...
def main():
    ...
    # Logging constants
    os.system('mkdir ./record/randM%sK%sCycle%sChain%sAction%sEmbedTime%s'% (M, K, CYCLE_CAP, CHAIN_CAP,action, TIME))
    PATH = './record/randM%sK%sCycle%sChain%sAction%sEmbedTime%s/' % (M, K, CYCLE_CAP, CHAIN_CAP,action,TIME)
    EXP = 0
