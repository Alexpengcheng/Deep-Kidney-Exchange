...
def learn(load_model, model_path, env, policy, vf, gamma, lam, timesteps_per_batch, num_timesteps,
    ...
    while True:
        ...
        # Save the model
        if timesteps_so_far % 10 == 0:
            U.save_state(model_path + '/model-' + str(timesteps_so_far) + '.cptk')
            print("Model saved")
