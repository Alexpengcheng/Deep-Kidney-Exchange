...
class GaussianMlpPolicy(object):
    def __init__(self, ob_dim, ac_dim, num_hid_layers, hid_size):
        ...
        for i in range(num_hid_layers):
            last_out = tf.nn.tanh(dense(last_out, hid_size, "h%s"%(i+1), weight_init=U.normc_initializer(1.0), bias_init=0.0, weight_loss_dict=wd_dict))
